...
public class AcceleriteSwordItem extends SwordItem implements ChargeableBySpeedItem, AccelerationEffectItem {
    ...
    public AcceleriteSwordItem(Properties properties) {
    ...
    public double getRequiredSpeed() {
        return NexusConfig.server.acceleriteSwordRepairSpeedRequirement.get();
    }

    @Override
    public int getAccelerationEffectDuration() {
        return NexusConfig.server.acceleriteSwordEffectDuration.get();
    }

    @Override
    public int getMaxAccelerationEffectStacks() {
        return NexusConfig.server.maxAcceleriteSwordEffectStack.get() - 1;
    }
}
